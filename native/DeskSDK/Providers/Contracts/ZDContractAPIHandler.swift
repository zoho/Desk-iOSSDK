...
@objc open class ZDContractAPIHandler:NSObject{
    ...
    @objc open static func listAllContracts(_ orgID:String = String().getZDOrgId(),optionalParams:Parameters = Parameters(),onComplition:@escaping (([ZDContract]?,Error?,Int)->())) -> Void {
